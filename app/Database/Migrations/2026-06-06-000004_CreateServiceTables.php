...
class CreateServiceTables extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'status_pengerjaan' => [
                'type' => 'ENUM("Antre","Diproses","Menunggu Part","Selesai","Diambil")',
                'default' => 'Antre',
            ],

            'status_transaksi' => [
                'type' => 'ENUM("Draft","Progress","Lunas","Dibatalkan")',
                'default' => 'Draft',
            ],

            'metode_pembayaran' => [
                'type' => 'ENUM("Tunai","QRIS","BRI","Dana")',
                'default' => 'Tunai',
            ],
        ...
        $this->forge->addUniqueKey(
            ['id_transaksi', 'id_part'],
            'unique_part_per_transaksi'
        );
