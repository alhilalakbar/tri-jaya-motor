        ...
        <form action="<?= base_url('backend/laporan/pembelian'); ?>" method="get" class="row g-3 align-items-end">
            ...
            <div class="col-md-6">
                <div class="btn-group me-2">
                    ...
                    <a href="<?= base_url('backend/laporan/pembelian'); ?>" class="btn btn-secondary shadow-sm"><i class="bi bi-arrow-clockwise"></i> Reset</a>
                </div>
                <div class="btn-group">
...
<div class="table-responsive">
    <table class="table table-bordered table-striped align-middle text-nowrap" id="tablePembelian">
        <thead class="table-dark">
            <tr>
                <th>#</th><th>Kode</th><th>Tanggal</th><th>Pemasok</th><th>Item</th><th>Jumlah</th><th>Harga Beli</th><th>Subtotal</th>
            </tr>
        </thead>
        <tbody>
            ...
            "buttons": [
                {
                    ...
                    title: 'Laporan Pembelian - ' + $('#tgl_mulai').val() + '_' + $('#tgl_akhir').val()
                },
                {
                    extend: 'pdfHtml5',
