...
<div class="card mb-3 shadow-sm border-0">
    <div class="card-body">
        <form action="<?= base_url('backend/laporan/pembelian'); ?>" method="get" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <div class="btn-group me-2">
                    ...
                    <a href="<?= base_url('backend/laporan/pembelian'); ?>" class="btn btn-secondary shadow-sm"><i
...
<div class="btn-group ms-2">
    <a href="<?= base_url('backend/laporan/export/excel/pembelian?tgl_mulai=' . $tgl_mulai . '&tgl_akhir=' . $tgl_akhir); ?>"
        class="btn btn-success shadow-sm">
        <i class="bi bi-file-earmark-excel"></i> Export Excel
    </a>

    <a href="<?= base_url('backend/laporan/export/pdf/pembelian?tgl_mulai=' . $tgl_mulai . '&tgl_akhir=' . $tgl_akhir); ?>"
...
<div class="card card-primary card-outline shadow-sm">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped align-middle text-nowrap" id="tablePembelian">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= $l->kode_pembelian; ?></td>
                        <td><?= date('d/m/Y', strtotime($l->tanggal_pembelian)); ?></td>
                        <td><?= $l->nama_pemasok; ?></td>
                        <td><?= $l->nama_part; ?></td>
                        <td class="text-center"><?= $l->jumlah_beli; ?></td>
                        <td class="text-end">Rp <?= number_format($l->harga_beli_satuan, 0, ',', '.'); ?></td>
                        <td class="text-end">Rp <?= number_format($l->subtotal, 0, ',', '.'); ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        $(document).ready(function() {
            $('#tablePembelian').DataTable({
                ...
                "buttons": [{
                        ...
                        title: 'Laporan Pembelian - ' + $('#tgl_mulai').val() + '_' + $(
                            '#tgl_akhir').val()
                    },
                    {
                        extend: 'pdfHtml5',
