...
<div class="table-responsive">
    <table class="table table-bordered table-striped align-middle text-nowrap" id="tableStok">
        <thead class="table-dark">
            <tr>
                <th>#</th><th>Kode</th><th>Sparepart</th><th>Kategori</th><th>Merek</th><th>Stok</th><th>Harga Jual</th><th>Status</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><span class="badge bg-<?= $l->status_stok == 'Aman' ? 'success' : 'danger'; ?>"><?= $l->status_stok; ?></span></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
            ...
            "buttons": [
                {
                    ...
                    title: 'Laporan Stok - ' + $('#tgl_mulai').val() + '_' + $('#tgl_akhir').val()
                },
                {
                    extend: 'pdfHtml5',
