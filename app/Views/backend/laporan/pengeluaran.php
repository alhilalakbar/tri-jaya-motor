        ...
        <form action="<?= base_url('backend/laporan/pengeluaran'); ?>" method="get" class="row g-3 align-items-end">
            ...
            <div class="col-md-6">
                <div class="btn-group me-2">
                    ...
                    <a href="<?= base_url('backend/laporan/pengeluaran'); ?>" class="btn btn-secondary shadow-sm"><i class="bi bi-arrow-clockwise"></i> Reset</a>
                </div>
                <div class="btn-group">
...
<div class="table-responsive">
    <table class="table table-bordered table-striped align-middle text-nowrap" id="tablePengeluaran">
        <thead class="table-dark">
            <tr>
                <th>#</th><th>Kategori</th><th>Jenis</th><th>Tanggal</th><th>Nominal</th><th>Keterangan</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><span class="badge bg-secondary"><?= $l->jenis_pengeluaran; ?></span></td>
                <td><?= date('d/m/Y', strtotime($l->tanggal)); ?></td>
                <td class="text-end text-danger">Rp <?= number_format($l->nominal, 0, ',', '.'); ?></td>
                <td><?= $l->keterangan; ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
            ...
            "buttons": [
                {
                    ...
                    title: 'Laporan Pengeluaran - ' + $('#tgl_mulai').val() + '_' + $('#tgl_akhir').val()
                },
                {
                    extend: 'pdfHtml5',
