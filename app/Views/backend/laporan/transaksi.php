...
<div class="card mb-3 shadow-sm border-0">
    <div class="card-body">
        <form action="<?= base_url('laporan/transaksi'); ?>" method="get" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <div class="btn-group me-2">
                    ...
                    <a href="<?= base_url('laporan/transaksi'); ?>" class="btn btn-secondary shadow-sm"><i
...
<div class="btn-group ms-2">
    <a href="<?= base_url('laporan/export/excel/transaksi?tgl_mulai=' . $tgl_mulai . '&tgl_akhir=' . $tgl_akhir); ?>"
        class="btn btn-success shadow-sm">
        <i class="bi bi-file-earmark-excel"></i> Export Excel
    </a>

    <a href="<?= base_url('laporan/export/pdf/transaksi?tgl_mulai=' . $tgl_mulai . '&tgl_akhir=' . $tgl_akhir); ?>"
        ...
        $(document).ready(function() {
            $('#tableTransaksi').DataTable({
                ...
                "buttons": [{
                        ...
                        title: 'Laporan Transaksi - ' + $('#tgl_mulai').val() + '_' + $(
                            '#tgl_akhir').val()
                    },
                    {
                        extend: 'pdfHtml5',
