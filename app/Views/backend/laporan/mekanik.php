        ...
        <form action="<?= base_url('backend/laporan/mekanik'); ?>" method="get" class="row g-3 align-items-end">
            ...
            <div class="col-md-6">
                <div class="btn-group me-2">
                    ...
                    <a href="<?= base_url('backend/laporan/mekanik'); ?>" class="btn btn-secondary shadow-sm"><i class="bi bi-arrow-clockwise"></i> Reset</a>
                </div>
                <div class="btn-group">
...
<div class="table-responsive">
    <table class="table table-bordered table-striped align-middle text-nowrap" id="tableMekanik">
        <thead class="table-dark">
            <tr>
                <th>#</th><th>Nama Mekanik</th><th>Total Servis</th><th>Pendapatan Jasa</th>
            </tr>
        </thead>
        <tbody>
            ...
            "buttons": [
                {
                    ...
                    title: 'Laporan Performa Mekanik - ' + $('#tgl_mulai').val() + '_' + $('#tgl_akhir').val()
                },
                {
                    extend: 'pdfHtml5',
