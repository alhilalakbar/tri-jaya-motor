...
<div class="card mb-3 shadow-sm border-0">
    <div class="card-body">
        <form action="<?= base_url('laporan/mekanik'); ?>" method="get" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <div class="btn-group me-2">
                    ...
                    <a href="<?= base_url('laporan/mekanik'); ?>" class="btn btn-secondary shadow-sm"><i
...
<div class="btn-group ms-2">
    <a href="<?= base_url('laporan/export/excel/mekanik?tgl_mulai=' . $tgl_mulai . '&tgl_akhir=' . $tgl_akhir); ?>"
        class="btn btn-success shadow-sm">
        <i class="bi bi-file-earmark-excel"></i> Export Excel
    </a>

    <a href="<?= base_url('laporan/export/pdf/mekanik?tgl_mulai=' . $tgl_mulai . '&tgl_akhir=' . $tgl_akhir); ?>"
